  ...
  return (
    <div className="landing-page min-h-screen w-full flex flex-col bg-white">
          ...
          <div className="mx-auto w-full px-6 sm:px-10 lg:px-16 xl:px-20 relative z-10" style={{ maxWidth: '1480px' }}>
            ...
            <section className="relative py-20 sm:py-28 lg:py-36 flex items-center min-h-[720px]">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-14 lg:gap-14 w-full items-center">
                <div className="order-2 lg:order-1 lg:w-full lg:max-w-[560px] lg:justify-self-end">
                ...
                <div className="flex items-center justify-center order-1 lg:order-2 lg:w-full lg:max-w-[560px] lg:justify-self-start">
            ...
            <section className="relative py-20 sm:py-28 lg:py-36 flex items-center min-h-[640px]">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-14 lg:gap-14 w-full items-center">
                <div className="flex items-center justify-center order-2 lg:order-1 lg:w-full lg:max-w-[560px] lg:justify-self-end">
                ...
                <div className="order-1 lg:order-2 lg:w-full lg:max-w-[560px] lg:justify-self-start">
      ...
      <footer className="w-full bg-slate-900 py-12 sm:py-16 border-t border-slate-800">
        <div className="mx-auto w-full px-6 sm:px-10 lg:px-16 xl:px-20" style={{ maxWidth: '1480px' }}>
