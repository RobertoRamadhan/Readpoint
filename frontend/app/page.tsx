          ...
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <section className="py-12 sm:py-16 lg:py-24 flex items-center min-h-screen lg:min-h-screen sm:min-h-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 w-full items-center">
                <div className="order-2 lg:order-1">
                  ...
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black leading-tight text-slate-900 mb-4 sm:mb-6">Tingkatkan Minat Baca Siswa dengan Sistem Reward Digital</h1>
                  <p className="text-base sm:text-lg text-slate-600 leading-relaxed mb-6 sm:mb-8">Platform membaca digital yang membuat siswa termotivasi untuk membaca, menyelesaikan kuis, dan mengumpulkan reward.</p>
            ...
            <section className="py-12 sm:py-16 lg:py-24 flex items-center min-h-screen lg:min-h-auto sm:min-h-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 w-full items-center">
                ...
                <div className="order-1 lg:order-2">
                  <h2 className="text-3xl sm:text-4xl lg:text-4xl font-black text-slate-900 mb-3 sm:mb-4">Dipercaya oleh Sekolah Terkemuka</h2>
                  <p className="text-base sm:text-lg text-slate-600 leading-relaxed mb-4 sm:mb-6">Ribuan sekolah dan guru telah menggunakan READPOINT untuk meningkatkan minat baca siswa mereka dengan hasil yang luar biasa.</p>
                  <p className="text-sm sm:text-base text-slate-600">Dari sekolah negeri hingga swasta, READPOINT telah membantu menciptakan budaya membaca yang lebih kuat di kalangan siswa.</p>
                </div>
              </div>
            </section>
                ...
                <div className="order-2 lg:order-1">
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    {[
                      ...
                      <div key={idx} className="rounded-lg border border-slate-200 bg-white p-4 sm:p-6 hover:shadow-lg transition-all hover:border-emerald-200">
                ...
                <div className="order-2 lg:order-1">
                  ...
                  <div className="grid grid-cols-2 gap-4 sm:gap-6">
                    {[
                      ...
                      <div key={idx} className="bg-emerald-50 rounded-lg p-4 sm:p-6 border border-emerald-200">
            ...
            <section className="py-12 sm:py-16 lg:py-24 flex items-center min-h-screen lg:min-h-auto sm:min-h-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 w-full items-center">
                ...
                <div className="order-1 lg:order-2">
                  <h2 className="text-3xl sm:text-4xl lg:text-4xl font-black text-slate-900 mb-6 sm:mb-8">Cara Kerja</h2>
                  <p className="text-base sm:text-lg text-slate-600 leading-relaxed mb-6 sm:mb-8">Proses sederhana untuk memulai perjalanan membaca</p>
            ...
            <section className="py-12 sm:py-16 lg:py-24 flex items-center min-h-screen lg:min-h-auto sm:min-h-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 w-full items-center">
                ...
                <div className="order-1 lg:order-2">
                  <h2 className="text-3xl sm:text-4xl lg:text-4xl font-black text-slate-900 mb-6 sm:mb-8">Apa Kata Mereka</h2>
                  <blockquote className="border-l-4 border-emerald-600 pl-4 sm:pl-6 mb-6 sm:mb-8">
