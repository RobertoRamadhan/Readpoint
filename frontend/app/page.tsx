      ...
      <nav className="w-full bg-white border-b border-emerald-100 shadow-sm sticky top-0 z-50">
        <div className="container mx-auto flex h-20 max-w-7xl items-center justify-between px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            <Link
              href="/login"
              className="rounded-lg px-8 py-3 text-lg font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 transition-all"
            >
              Masuk
            </Link>
            <Link
              href="/register"
              className="rounded-lg bg-gradient-to-r from-emerald-600 to-teal-600 px-8 py-3 text-lg font-bold text-white hover:from-emerald-700 hover:to-teal-700 transition-all shadow-lg hover:shadow-xl"
            >
              Daftar
            </Link>
          </div>
      ...
      <main className="flex-1">
        ...
        <section className="w-full bg-gradient-to-b from-white to-emerald-50 py-24 lg:py-40">
          <div className="container mx-auto max-w-5xl px-6 lg:px-8">
            <div className="text-center">
              <span className="mb-5 inline-block rounded-full bg-emerald-100 px-5 py-2 text-sm font-bold text-emerald-700">
                Platform Literasi Digital
              </span>
              <h1 className="mb-6 text-5xl font-black leading-tight text-slate-900 lg:text-6xl">
              ...
              <p className="mb-10 text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto">
                Platform membaca digital yang membuat siswa termotivasi untuk membaca, menyelesaikan kuis, dan mengumpulkan reward.
              </p>

              <div className="flex justify-center gap-4">
                <Link
                  href="/register"
                  className="rounded-lg bg-gradient-to-r from-emerald-600 to-teal-600 px-8 py-3 text-lg font-bold text-white hover:from-emerald-700 hover:to-teal-700 transition-all shadow-lg"
                >
                  Mulai Sekarang
                </Link>
                <Link
                  href="/login"
                  className="rounded-lg border border-emerald-200 bg-white px-8 py-3 text-lg font-bold text-emerald-700 hover:bg-emerald-50 transition-all"
                >
                  Masuk
                </Link>
              </div>
          ...
          <div className="container mx-auto max-w-5xl px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              {[
                ...
                <div
                  key={idx}
                  className="rounded-xl border border-emerald-100 bg-white p-8 text-center hover:shadow-lg transition-all"
                >
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div key={idx} className="text-center">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-emerald-600 to-teal-600 text-white font-black text-lg flex items-center justify-center mx-auto mb-4 shadow-md">
                    {step.number}
                  </div>
        ...
        <section className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 py-20 lg:py-24">
          <div className="container mx-auto max-w-4xl px-6 lg:px-8 text-center">
            ...
            <Link
              href="/register"
              className="inline-block rounded-lg bg-white px-8 py-3 font-bold text-emerald-700 hover:bg-slate-100 transition-all shadow-lg"
            >
              Daftar Gratis
            </Link>
          </div>
