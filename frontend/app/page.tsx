        ...
        <div className="mx-auto grid w-full max-w-7xl items-center gap-12 lg:grid-cols-[1fr_0.95fr]">
          ...
          <div className="mx-auto w-full max-w-xl">
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl shadow-slate-200/80">
              <div className="mb-6">
                <p className="text-sm font-black uppercase tracking-[0.18em] text-emerald-700">Fokus READPOINT</p>
                <h2 className="mt-2 text-2xl font-black text-slate-900">Fitur utama aplikasi literasi</h2>
              </div>
