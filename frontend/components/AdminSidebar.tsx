...
export default function AdminSidebar({
  ...
  return (
    <aside
      className={`${sidebarRoleClass} fixed left-0 top-0 z-50 flex h-screen w-64 flex-col overflow-hidden border-r border-slate-800 bg-slate-950 text-white shadow-xl transition-transform duration-300 sm:w-72 md:w-72 md:translate-x-0 md:shadow-none ${sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}
            ...
            <div key={item.id} className="readpoint-admin-menu-group">
              ...
              >
                <span className="flex min-w-0 flex-1 items-center gap-3">
                  ...
                  <span className="readpoint-admin-menu-label block min-w-0 flex-1 truncate">
                    {item.label}
                  </span>
                </span>
                {hasSubItems && (
